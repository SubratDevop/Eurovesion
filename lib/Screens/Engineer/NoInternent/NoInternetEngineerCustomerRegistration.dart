...
class NoInternetEngineerCustomerRegistration extends StatelessWidget {
...
class _NoInternetScreenState extends State<NoInternetScreen> {
  ...
  @override
    void initState() {
      ...
      Timer(Duration(seconds: 3),()=>Navigator.pushReplacement(context, MaterialPageRoute(builder:(context)=>EngineerCustomerRegistration())));
  }
