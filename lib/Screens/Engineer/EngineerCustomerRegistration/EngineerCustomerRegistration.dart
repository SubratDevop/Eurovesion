...
class EngineerCustomerRegistration extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: EngineerCustomerRegistrationScreen(),
    );
  }
}

class EngineerCustomerRegistrationScreen extends StatefulWidget {
  //const CustomerRegistrationScreen({ Key? key }) : super(key: key);

  @override
  _EngineerCustomerRegistrationScreenState createState() =>
      _EngineerCustomerRegistrationScreenState();
}

class _EngineerCustomerRegistrationScreenState
    extends State<EngineerCustomerRegistrationScreen> {
  ...
  Future<void> _checkInternetConnection() async {
    try {
      ...
      Navigator.of(context, rootNavigator: true).push(MaterialPageRoute(
          builder: (context) => NoInternetEngineerCustomerRegistration()));
    }
  }
