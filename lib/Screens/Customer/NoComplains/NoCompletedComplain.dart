...
class NoCompletedComplain extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: NoCompletedComplainScreen(),
    );
  }
}

class NoCompletedComplainScreen extends StatefulWidget {
 
  @override
  _NoCompletedComplainScreenState createState() => _NoCompletedComplainScreenState();
}

class _NoCompletedComplainScreenState extends State<NoCompletedComplainScreen> {
  ...
  void initState() {
   ...
   // BackButtonInterceptor.add(myInterceptor);
    //Timer(Duration(seconds: 3),()=>Navigator.pushReplacement(context, MaterialPageRoute(builder:(context)=>CustomerCompletedComplain())));
  }
                    ...
                    Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          onPressed: () {
                            Navigator.of(context,rootNavigator: true).push(MaterialPageRoute(builder: (context)=> CustomerCompletedComplain()));                      
                          }
                        ),
                      ),
                    ),
